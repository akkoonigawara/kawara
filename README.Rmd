...
You can download the compendium as a zip from from this URL: <https://github.com/akkoonigawara/kawara/archive/master.zip>

Or you can install this compendium as an R package, kawara, from GitHub with:
